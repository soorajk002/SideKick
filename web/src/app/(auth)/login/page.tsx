            ...
            <div className="mt-10">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <button
                  ...
                  className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 transition"
                >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-primary-600 to-blue-700 flex items-center justify-center p-12">
          <div className="max-w-md text-white">
            <h2 className="text-3xl font-bold mb-4">
              Close 40% more deals with AI-powered sales checklists
            </h2>
            <p className="text-primary-100 text-lg mb-8">
              Join thousands of sales professionals using Sidekick to never miss a step in their calls.
            </p>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-white/90">
                  AI automatically checks off items as you cover them
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center mt-1">
                ...
                <p className="text-white/90">
                  Real-time coaching during your calls
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-white/20 flex items-center justify-center mt-1">
                ...
                <p className="text-white/90">
                  Track what works and coach your team
                </p>
              </div>
            </div>
          </div>
